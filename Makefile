...
DIST_COMMON = README $(am__configure_deps) $(srcdir)/Makefile.am \
	$(srcdir)/Makefile.in $(srcdir)/freetds.spec.in \
...
CONFIG_CLEAN_FILES = freetds.spec
...
abs_builddir = /Users/mattdurham/Source/freetds-dev.0.92.377
abs_srcdir = /Users/mattdurham/Source/freetds-dev.0.92.377
...
$(am__aclocal_m4_deps):
freetds.spec: $(top_builddir)/config.status $(srcdir)/freetds.spec.in

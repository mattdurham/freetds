...
ALL :  \
	...
	"$(OUTDIR)\peter.exe" \
	"$(OUTDIR)\test64.exe" \
	"$(OUTDIR)\prepare_warn.exe" \
	"$(OUTDIR)\long_error.exe" \
	"$(OUTDIR)\mars1.exe" \
	"$(OUTDIR)\array_error.exe"
...
"$(OUTDIR)\prepare_warn.exe" : "$(OUTDIR)" "$(INTDIR)\common.obj" "$(INTDIR)\prepare_warn.obj"
	$(LINK32) $(LINK32_FLAGS) "$(INTDIR)\common.obj" "$(INTDIR)\prepare_warn.obj" /pdb:"$(OUTDIR)\prepare_warn.pdb" /out:"$(OUTDIR)\prepare_warn.exe"

"$(OUTDIR)\long_error.exe" : "$(OUTDIR)" "$(INTDIR)\common.obj" "$(INTDIR)\long_error.obj"
	$(LINK32) $(LINK32_FLAGS) "$(INTDIR)\common.obj" "$(INTDIR)\long_error.obj" /pdb:"$(OUTDIR)\long_error.pdb" /out:"$(OUTDIR)\long_error.exe"

"$(OUTDIR)\mars1.exe" : "$(OUTDIR)" "$(INTDIR)\common.obj" "$(INTDIR)\mars1.obj"
	$(LINK32) $(LINK32_FLAGS) "$(INTDIR)\common.obj" "$(INTDIR)\mars1.obj" /pdb:"$(OUTDIR)\mars1.pdb" /out:"$(OUTDIR)\mars1.exe"

"$(OUTDIR)\array_error.exe" : "$(OUTDIR)" "$(INTDIR)\common.obj" "$(INTDIR)\array_error.obj"
	$(LINK32) $(LINK32_FLAGS) "$(INTDIR)\common.obj" "$(INTDIR)\array_error.obj" /pdb:"$(OUTDIR)\array_error.pdb" /out:"$(OUTDIR)\array_error.exe"
